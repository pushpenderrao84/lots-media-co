          ...
          <div className="order-2 md:order-1">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Button 
                asChild
                size="lg" 
                className="bg-warm-yellow text-charcoal hover:bg-warm-yellow/90 font-medium"
              >
                <a href="#portfolio">
                  View Portfolio
          ...
          <div className="order-1 md:order-2 flex justify-center md:justify-end">
            <div className="relative w-full max-w-md">
              <div className="aspect-square bg-warm-yellow rounded-3xl overflow-hidden shadow-xl animate-float">
                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1633598046046-1402787c97fc?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center opacity-80 mix-blend-multiply"></div>
              </div>
