          ...
          <div className="order-1 md:order-2 flex justify-center md:justify-end">
            <div className="relative w-full max-w-md">
              <div className="aspect-square bg-warm-yellow rounded-3xl overflow-hidden shadow-xl animate-float">
                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1558707538-c56435bdcdf3?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center opacity-80 mix-blend-multiply"></div>
              </div>
